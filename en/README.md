...
<div style="display: flex; flex-wrap: nowrap; align-items: center; justify-content: space-between;">
  ...
  <img src="https://github.com/transover/sEMG-MMG_SYNC/blob/main/en/Synchronous_Architecture.svg" alt="Synchronous_Architecture" style="height: 380px; max-width: 100%; object-fit: contain;">
</div>
