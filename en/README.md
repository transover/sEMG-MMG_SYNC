...
<div style="display: flex; flex-wrap: nowrap; align-items: center; justify-content: space-between;">
  ...
  <img src="https://github.com/transover/sEMG-MMG_SYNC/blob/main/en/Synchronous_Architecture.svg" alt="Synchronous_Architecture" style="height: 400px; max-width: 95%; object-fit: contain;">
</div>
