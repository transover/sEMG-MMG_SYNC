...
![Example of signal acquisition process](https://github.com/transover/sEMG-MMG_SYNC/blob/main/ExampleData/SignalAcquisition.gif)
...
- Through the menu bar buttons on the interface, you can change the language of the interface：
